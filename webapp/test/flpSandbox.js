		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "sales order app from hpc",
									"targetURL": "#hpcsozhpcsoapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hpcsozhpcsoapp-display": {
								"semanticObject": "hpcsozhpcsoapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hpc.so.zhpcsoapp",
									"url": sap.ui.require.toUrl("hpc/so/zhpcsoapp")
								}
							}
						}
					}
